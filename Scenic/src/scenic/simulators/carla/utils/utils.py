...
# class PedestrianDetectionStatus:
#     def __init__(self):
#         self._pedestrian_detected = None

#     def set_pedestrian_detected(self, **kwargs):
#         if "pedestrian_detected" in kwargs:
#             self._pedestrian_detected = kwargs["pedestrian_detected"]
#         else:
#             pass  # Optionally, handle the case where the argument is not provided

#     def get_pedestrian_detected(self):
#         return self._pedestrian_detected


# def carlaToScenicPerceptionComponentFlags_set_pedestrian_detected(**kwargs):
#     if "pedestrian_detected" in kwargs:
#         global pedestrian_detected
#         pedestrian_detected = kwargs["pedestrian_detected"]
#     else:
#         pass


def carlaToScenicPerceptionComponentFlags(**kwargs):
    # for k, v in kwargs.items():
    #     print(k, v)
    pedestrian_detected = None
    if "pedestrian_detected" in kwargs:
        pedestrian_detected = kwargs["pedestrian_detected"]
